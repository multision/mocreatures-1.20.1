...
public class MoCEntities {
     ...
     * Animal entities
     */
    public static final RegistryObject<EntityType<MoCEntityBird>> BIRD = registerEntity("bird", MoCEntityBird::new, MobCategory.CREATURE, 0.5F, 0.9F, MoCEntityBird::createAttributes, 37109, 4609629);
    ...
    public static final RegistryObject<EntityType<MoCEntityBunny>> BUNNY = registerEntity("bunny", MoCEntityBunny::new, MobCategory.CREATURE, 0.5F, 0.5F, MoCEntityBunny::createAttributes, 8741934, 14527570);
    ...
    public static final RegistryObject<EntityType<MoCEntityDuck>> DUCK = registerEntity("duck", MoCEntityDuck::new, MobCategory.CREATURE, 0.4F, 0.7F, MoCEntityDuck::createAttributes, 3161353, 14011565);
    public static final RegistryObject<EntityType<MoCEntityDeer>> DEER = registerEntity("deer", MoCEntityDeer::new, MobCategory.CREATURE, 0.9F, 1.425F, MoCEntityDeer::createAttributes, 11572843, 13752020);
    public static final RegistryObject<EntityType<MoCEntityElephant>> ELEPHANT = registerEntity("elephant", MoCEntityElephant::new, MobCategory.CREATURE, 1.1F, 3F, MoCEntityElephant::createAttributes, 4274216, 9337176);
    public static final RegistryObject<EntityType<MoCEntityEnt>> ENT = registerEntity("ent", MoCEntityEnt::new, MobCategory.CREATURE, 1.4F, 7F, MoCEntityEnt::createAttributes, 9794886, 5800509);
    public static final RegistryObject<EntityType<MoCEntityFilchLizard>> FILCH_LIZARD = registerEntity("filchlizard", MoCEntityFilchLizard::new, MobCategory.CREATURE, 0.6f, 0.5f, MoCEntityFilchLizard::createAttributes, 9930060, 5580310);
    ...
    public static final RegistryObject<EntityType<MoCEntityMole>> MOLE = registerEntity("mole", MoCEntityMole::new, MobCategory.CREATURE, 1F, 0.5F, MoCEntityMole::createAttributes, 263173, 10646113);
    public static final RegistryObject<EntityType<MoCEntityMouse>> MOUSE = registerEntity("mouse", MoCEntityMouse::new, MobCategory.CREATURE, 0.45F, 0.3F, MoCEntityMouse::createAttributes, 7428164, 15510186);
    ...
    public static final RegistryObject<EntityType<MoCEntityTurtle>> TURTLE = registerEntity("turtle", MoCEntityTurtle::new, MobCategory.CREATURE, 0.6F, 0.425F, MoCEntityTurtle::createAttributes, 6505237, 10524955);
    public static final RegistryObject<EntityType<MoCEntityTurkey>> TURKEY = registerEntity("turkey", MoCEntityTurkey::new, MobCategory.CREATURE, 0.6F, 0.9F, MoCEntityTurkey::createAttributes, 12268098, 6991322);
    public static final RegistryObject<EntityType<MoCEntityHorse>> WILDHORSE = registerEntity("wildhorse", MoCEntityHorse::new, MobCategory.CREATURE, 1.3964844F, 1.6F, MoCEntityHorse::createAttributes, 9204829, 11379712);
        ...
        ENTITY_ATTRIBUTES.forEach((entityType, attributeSupplier) -> {
            try {
                ...
                if (entityType.isPresent()) {
                    ...
                    MoCreatures.LOGGER.warn("Skipping attributes for entity that's not present: {}", entityType.getId());
                }
            } catch (Exception e) {
